...
#ifndef MGSCROLLBARCONTROL_H
#define MGSCROLLBARCONTROL_H

/*
  The superclass of all scrollbar controls.
*/
#include "mgControl.h"
#include "mgScroller.h"

class mgScrollbarControl : public mgControl, public mgScroller
{
public:
  // constructor
  mgScrollbarControl(
