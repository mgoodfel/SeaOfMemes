...
class mgUglyList: public mgListControl,
...
protected:
  ...
  mgUglyScrollbar* m_vertScroller;             // vertical scroll bar, if any
  mgUglyScrollbar* m_horzScroller;             // horizontal scroll bar, if any
