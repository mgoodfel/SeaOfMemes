...
#ifndef MGGENERICBUTTON_H
#define MGGENERICBUTTON_H
...
class mgGenericButton : public mgButtonControl, public mgMouseListener, public mgFocusListener
{
public:
  // constructor
  mgGenericButton(
...
protected:    
  ...
  const mgGenericFace* m_upFace;
  const mgGenericFace* m_downFace;
  const mgGenericFace* m_hoverFace;
  const mgGenericFace* m_disabledFace;
