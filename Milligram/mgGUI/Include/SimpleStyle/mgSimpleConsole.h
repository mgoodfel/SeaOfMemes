/*
  ...
  this notice.
*/
#ifndef MGSIMPLECONSOLE_H
#define MGSIMPLECONSOLE_H
...
/*
  A scrolling text control, used for "console"-style debug output.
*/
class mgSimpleConsole : public mgConsoleControl, public mgScrollListener
{
public:
  // constructor
  mgSimpleConsole(
...
protected:
  ...
  mgSimpleScrollbar* m_vertScroller;
  mgSimpleScrollbar* m_horzScroller;
