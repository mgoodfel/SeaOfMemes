/*
  ...
  this notice.
*/
#ifndef MGSIMPLEFIELD_H
#define MGSIMPLEFIELD_H
...
*/
class mgSimpleField : public mgFieldControl, public mgKeyListener, public mgMouseListener, 
