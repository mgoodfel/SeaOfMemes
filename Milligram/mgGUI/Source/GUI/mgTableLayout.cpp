...
#ifdef TRACE_TABLES
  mgDebug("Layout minimum size = %d by %d", size.m_width, size.m_height);
#endif
}
...
#ifdef TRACE_TABLES
  mgDebug("Layout preferredSize = (%d, %d)", size.m_width, size.m_height);
#endif
}
...
#ifdef TRACE_TABLES
  mgDebug("Layout preferredSizeAtWidth(%d) = (%d, %d)", width, size.m_width, size.m_height);
#endif
  return true;
}
