...
void mgUglyList::addSelectListener(
...
void mgUglyList::removeSelectListener(
  mgSelectListener* listener)
{
  if (m_selectListeners == NULL)
    return;
...
void mgUglyList::sendSelectEvent(
...
void mgUglyList::setMultiSelect(
  BOOL multiSelect)
{
...
int mgUglyList::getSelectionCount()
{
  if (m_multiSelect)
  {
    int count = 0;
...
void mgUglyList::getSelectedItem(
  int posn,
  mgString &name)
{
  int count = 0;
...
//--------------------------------------------------------------
// update scrollbars
void mgUglyList::updateScrollers()
{
  mgDimension size;
  getSize(size);
...
//--------------------------------------------------------------
// line up
void mgUglyList::guiScrollLineUp(
  void* source)
{
...
//--------------------------------------------------------------
// line down
void mgUglyList::guiScrollLineDown(
  void* source)
{
  if (source == (mgScroller*) m_vertScroller)
  {
...
//--------------------------------------------------------------
// page up
void mgUglyList::guiScrollPageUp(
  void* source)
{
  if (source == (mgScroller*) m_vertScroller)
  {
...
//--------------------------------------------------------------
// page down
void mgUglyList::guiScrollPageDown(
  void* source)
{
  if (source == (mgScroller*) m_vertScroller)
  {
...
//--------------------------------------------------------------
// set position
void mgUglyList::guiScrollSetPosition(
  void* source,
  int value)
{
...
//--------------------------------------------------------------
// focus gained
void mgUglyList::guiFocusGained(
  void* source)
{
}
