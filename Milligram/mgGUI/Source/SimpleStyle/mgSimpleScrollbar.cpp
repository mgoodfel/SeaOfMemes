...
//--------------------------------------------------------------
// constructor
mgSimpleScrollbar::mgSimpleScrollbar(
  mgControl* parent,
  const char* cntlName)
: mgScrollbarControl(parent, cntlName)
{
  ...
  style->getFontAttr(MG_STYLE_SCROLLBAR, getName(), "font", m_font);

  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "upFrame", m_upFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "disFrame", m_disFrame);

  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "lineUpFrame", m_lineUpFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "lineHoverFrame", m_lineHoverFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "lineDownFrame", m_lineDownFrame);

  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "pageUpFrame", m_pageUpFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "pageHoverFrame", m_pageHoverFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "pageDownFrame", m_pageDownFrame);

  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "sliderUpFrame", m_sliderUpFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "sliderHoverFrame", m_sliderHoverFrame);
  style->getFrameAttr(MG_STYLE_SCROLLBAR, getName(), "sliderDownFrame", m_sliderDownFrame);
...
void mgSimpleScrollbar::setHorizontal(
  BOOL horizontal)
{
...
void mgSimpleScrollbar::paintPart(
  mgContext* gc,
  const mgFrame* frame,
  const mgIcon* icon,
...
void mgSimpleScrollbar::minimumSize(
  mgDimension& size) 
{
  preferredSize(size);
}
...
void mgSimpleScrollbar::preferredSize(
  mgDimension& size) 
{
  int iconHeight = m_font->getHeight();
...
//--------------------------------------------------------------
// mouse entered
void mgSimpleScrollbar::mouseEnter(
  void* source,
  int x,
  int y)
{
...
//--------------------------------------------------------------
// mouse exited
void mgSimpleScrollbar::mouseExit(
  void* source)
{
...
//--------------------------------------------------------------
// mouse pressed
void mgSimpleScrollbar::mouseDown(
  void* source,
  int x,
  int y,
  int modifiers,
...
//--------------------------------------------------------------
// mouse released
void mgSimpleScrollbar::mouseUp(
  void* source,
  int x,
  int y,
  int modifiers,
...
//--------------------------------------------------------------
// mouse clicked
void mgSimpleScrollbar::mouseClick(
  void* source,
  int x,
  int y,
  int modifiers,
...
//--------------------------------------------------------------
// mouse dragged
void mgSimpleScrollbar::mouseDrag(
  void* source,
  int x,
  int y,
  int modifiers)
...
//--------------------------------------------------------------
// mouse moved
void mgSimpleScrollbar::mouseMove(
  void* source,
  int x,
  int y,
  int modifiers)
...
//--------------------------------------------------------------
// time has passed
void mgSimpleScrollbar::guiTimerTick(
  double now,
  double since)
{
  // do first scroll event
...
void mgSimpleScrollbar::addScrollListener(
...
void mgSimpleScrollbar::removeScrollListener(
  mgScrollListener* listener) 
{
  if (m_scrollListeners == NULL)
    return;
...
//--------------------------------------------------------------
// send scroll event
void mgSimpleScrollbar::sendScrollEvent(
  int scrollType,
  int value)
{
  if (m_scrollListeners == NULL)
...
void mgSimpleScrollbar::setRange(
  int minRange,
  int lenRange) 
{
...
void mgSimpleScrollbar::setView(
  int minView,
  int lenView) 
{
  // handle empty view
...
void mgSimpleScrollbar::getRange(
  int& minRange,
  int& lenRange) 
{
  minRange = m_minRange;
...
void mgSimpleScrollbar::getView(
  int& minView,
  int& lenView) 
{
  minView = m_minView;
...
BOOL mgSimpleScrollbar::isFullView() 
{
