...
void mgSimpleField::enableHistory(
  BOOL enable)
{
  if (enable)
  {
...
void mgSimpleField::setDisplayCount(
  int count)
{
...
void mgSimpleField::preferredSize(
  mgDimension& size) 
{
...
void mgSimpleField::addChangeListener(
...
void mgSimpleField::removeChangeListener(
  mgChangeListener* listener)
{
  if (m_changeListeners == NULL)
    return;
...
void mgSimpleField::sendChangeEvent()
{
  if (m_changeListeners == NULL)
    return;
  ...
  for (int i = 0; i < m_changeListeners->length(); i++)
  {
    ...
    listener->guiChange(this, getName());
  }
}
...
//--------------------------------------------------------------
void mgSimpleField::guiFocusGained(
  void* source)
{
  damage();
}
...
//--------------------------------------------------------------
void mgSimpleField::guiFocusLost(
  void* source)
{
  damage();
}
