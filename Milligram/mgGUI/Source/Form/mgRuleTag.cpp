  ...
  mgXMLParser* parser)
{
  ...
  text->writeClear(mgTextAlignHCenter);
  text->writeBreak(100);
  ...
  const char* attrValue)
{
  ...
  // =-= could have some style attributes
}

//--------------------------------------------------------------
// text content
void mgRuleTag::tagContent(
  mgXMLParser* parser,
  const char* string,
  int len)
{
