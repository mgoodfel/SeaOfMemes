...
void mgWinServices::setErrorTable(
  mgErrorTable* table)
{
  delete m_errorTable;
  m_errorTable = NULL;
...
int mgWinServices::getDepthBits()
{
  if (m_support != NULL)
...
void mgWinServices::setDisplayLibrary(
  const char* library)
{
  m_library = library;
}
...
void mgWinServices::getDisplayLibrary(
  mgString& library)
{
...
void mgWinServices::termDisplay()
{
  if (m_support != NULL)
  {
...
void mgWinServices::swapBuffers()
{
  if (m_support == NULL)
...
void mgWinServices::resetTiming()
{
  m_frameCount = 0;
...
DWORD mgWinServices::compileGLShaderPair(
...
//--------------------------------------------------------------
// terminate view
void mgWinServices::termView()
{
}

//--------------------------------------------------------------
// set app fullscreen or windowed
void mgWinServices::setFullscreen(
  BOOL fullscreen)
{
...
//--------------------------------------------------------------
// set app fullscreen or windowed
BOOL mgWinServices::getFullscreen()
{
  return m_fullscreen;
}
...
void mgWinServices::setWindowTitle(
  const char* title)
{
  m_windowTitle = title;
...
void mgWinServices::getWindowTitle(
  mgString& title)
{
  title = m_windowTitle;
}
...
void mgWinServices::setWindowBounds(
  int windowX, 
  int windowY, 
  int windowWidth,
  int windowHeight)
...
void mgWinServices::getWindowBounds(
  int& windowX, 
  int& windowY, 
  int& windowWidth,
  int& windowHeight)
...
void mgWinServices::setSwapImmediate(
  BOOL swapImmediate)
{
...
//--------------------------------------------------------------
// get swap mode
BOOL mgWinServices::getSwapImmediate()
{
...
//--------------------------------------------------------------
// enable multisample
void mgWinServices::setMultiSample(
  BOOL multiSample)
{
...
//--------------------------------------------------------------
// get multisample
BOOL mgWinServices::getMultiSample()
{
...
BOOL mgWinServices::checkErrors()
{
  if (m_support != NULL)
...
void mgWinServices::drawOverlayTexture(
  DWORD texture,
  int x, 
  int y,
  int width,
...
void mgWinServices::restoreDisplayMode()
{
...
void mgWinServices::registerWindowClass()
{
...
//--------------------------------------------------------------
// create window 
void mgWinServices::createWindow()
{
  DWORD dwExStyle = 0;
...
//--------------------------------------------------------------
// destroy our window 
void mgWinServices::destroyWindow()
{
  if (m_window != NULL)
  {
...
//--------------------------------------------------------------
// terminate windows
void mgWinServices::termWindowClass()
{
...
void mgWinServices::setMouseRelative(
  BOOL relative)
{
...
BOOL mgWinServices::getMouseRelative()
{
...
void mgWinServices::windowResized(
  WPARAM  wParam,
  LPARAM  lParam)
{
...
int mgWinServices::translateKey(
  int key)
{
  switch (key)
  {
...
{
  mgWinServices* platform = (mgWinServices*) mgPlatform;
