...
*/
#include "stdafx.h"
#if defined(SUPPORT_GL33) && defined(__APPLE__)
...
//--------------------------------------------------------------
// constructor
mgOSXGL33Support::mgOSXGL33Support()
{
  m_overlayShader = 0;
  m_overlayObject = 0;
  m_overlayVertexes = 0;
...
//--------------------------------------------------------------
// initialize graphics
BOOL mgOSXGL33Support::initDisplay()
{
  // see if we have correct OpenGL version
  mgString errMsg;
  if (!checkVersion(302, 105, errMsg))
  {
...
//--------------------------------------------------------------
// terminate graphics
void mgOSXGL33Support::termDisplay()
{
}

//-----------------------------------------------------------------------------
// update graphics in window
void mgOSXGL33Support::swapBuffers()
{
  glFlush();
}
...
//--------------------------------------------------------------
// check for GL errors
BOOL mgOSXGL33Support::checkError()
{
...
BOOL mgOSXGL33Support::checkVersion(
  int reqGLVersion,
...
GLuint mgOSXGL33Support::compileShader(
  const char* source,
  GLenum shaderType)
{
...
DWORD mgOSXGL33Support::compileShaderPair(
...
void mgOSXGL33Support::drawOverlayTexture(
  DWORD texture,
  int x, 
  int y,
  int width,
