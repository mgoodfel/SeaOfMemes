...
*/
#include "stdafx.h"
#if defined(__APPLE__) && defined(SUPPORT_GL21)
...
//--------------------------------------------------------------
// constructor
mgOSXGL21Support::mgOSXGL21Support()
{
  m_overlayShader = 0;
  m_overlayVertexes = 0;
}
...
//--------------------------------------------------------------
// initialize graphics
BOOL mgOSXGL21Support::initDisplay()
{
  // see if we have correct OpenGL version
  mgString errMsg;
  if (!checkVersion(201, 102, errMsg))
  {
    mgDebug("%s", (const char*) errMsg);
    return false;
  }
  mgDebug("Using OpenGL version 2.1");   
...
//--------------------------------------------------------------
// terminate graphics
void mgOSXGL21Support::termDisplay()
{
}

//-----------------------------------------------------------------------------
// update graphics in window
void mgOSXGL21Support::swapBuffers()
{
  glFlush();
}
...
//--------------------------------------------------------------
// check for GL errors
BOOL mgOSXGL21Support::checkError()
{
...
BOOL mgOSXGL21Support::checkVersion(
  int reqGLVersion,
...
void mgOSXGL21Support::getShaderLog(
  GLuint shader,
  mgString& log)
{
  GLint logLen, retLen;
...
GLuint mgOSXGL21Support::compileShader(
  const char* source,
  GLenum shaderType)
{
...
DWORD mgOSXGL21Support::compileShaderPair(
...
void mgOSXGL21Support::drawOverlayTexture(
  DWORD texture,
  int x, 
  int y,
  int width,
