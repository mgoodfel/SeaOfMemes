...
#if defined(SUPPORT_GL21) && defined(__unix__)
...
const char* GL21_OVERLAY_VERTEX_SHADER = "           \n\
#version 120                                         \n\
...
const char* GL21_OVERLAY_FRAGMENT_SHADER = "         \n\
#version 120                                         \n\
...
//--------------------------------------------------------------
// constructor
mgLinuxGL21Support::mgLinuxGL21Support()
{
  m_overlayShader = 0;
  m_overlayVertexes = 0;
}
...
BOOL mgLinuxGL21Support::initDisplay()
{
  ...
  if (m_overlayShader == 0)
  {
    mgDebug("could not compile overlay shader");
    termDisplay();
    return false; 
  }
...
//--------------------------------------------------------------
// terminate graphics
void mgLinuxGL21Support::termDisplay()
{
  mgLinuxServices* system = (mgLinuxServices*) mgPlatform;
...
void mgLinuxGL21Support::swapBuffers()
{
  mgLinuxServices* system = (mgLinuxServices*) mgPlatform;
...
//--------------------------------------------------------------
// check for GL errors
BOOL mgLinuxGL21Support::checkError()
{
...
BOOL mgLinuxGL21Support::checkVersion(
  int reqGLVersion,
...
void mgLinuxGL21Support::getShaderLog(
  GLuint shader,
  mgString& log)
{
  GLint logLen, retLen;
...
GLuint mgLinuxGL21Support::compileShader(
  const char* source,
  GLenum shaderType)
{
...
DWORD mgLinuxGL21Support::compileShaderPair(
...
void mgLinuxGL21Support::drawOverlayTexture(
  DWORD texture,
  int x, 
  int y,
  int width,
