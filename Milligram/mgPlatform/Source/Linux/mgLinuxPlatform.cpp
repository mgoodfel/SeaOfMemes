...
//--------------------------------------------------------------
// constructor
mgLinuxPlatform::mgLinuxPlatform()
{
...
void mgLinuxPlatform::setErrorTable(
  mgErrorTable* table)
{
  delete m_errorTable;
  m_errorTable = NULL;
...
int mgLinuxPlatform::getDepthBits()
{
  if (m_support != NULL)
...
void mgLinuxPlatform::scanFontDir(
...
void mgLinuxPlatform::getFontDirectories(
  mgStringArray& fontDirs)
{
...
void mgLinuxPlatform::setDisplayLibrary(
  const char* library)
{
  m_library = library;
}
...
void mgLinuxPlatform::getDisplayLibrary(
  mgString& library)
{
...
//--------------------------------------------------------------
// initialize display.  
void mgLinuxPlatform::initDisplay()
{
  createWindow();
...
void mgLinuxPlatform::termDisplay()
{
  if (m_support != NULL)
  {
...
void mgLinuxPlatform::swapBuffers()
{
  if (m_support == NULL)
...
void mgLinuxPlatform::resetTiming()
{
  m_frameCount = 0;
...
void mgLinuxPlatform::logTiming(
  BOOL forceReport)
{
  if (m_frameCount == 0)
    return;
...
DWORD mgLinuxPlatform::compileGLShaderPair(
...
void mgLinuxPlatform::setFullscreen(
  BOOL fullscreen)
{
...
//--------------------------------------------------------------
// set app fullscreen or windowed
BOOL mgLinuxPlatform::getFullscreen()
{
  return m_fullscreen;
}
...
void mgLinuxPlatform::setWindowTitle(
  const char* title)
{
  m_windowTitle = title;
...
void mgLinuxPlatform::getWindowTitle(
  mgString& title)
{
  title = m_windowTitle;
}
...
void mgLinuxPlatform::setWindowBounds(
  int windowX, 
  int windowY, 
  int windowWidth,
  int windowHeight)
...
void mgLinuxPlatform::getWindowBounds(
  int& windowX, 
  int& windowY, 
  int& windowWidth,
  int& windowHeight)
...
void mgLinuxPlatform::setSwapImmediate(
  BOOL swapImmediate)
{
...
//--------------------------------------------------------------
// get swap mode
BOOL mgLinuxPlatform::getSwapImmediate()
{
...
//--------------------------------------------------------------
// enable multisample
void mgLinuxPlatform::setMultiSample(
  BOOL multiSample)
{
...
//--------------------------------------------------------------
// get multisample
BOOL mgLinuxPlatform::getMultiSample()
{
...
//-----------------------------------------------------------------------------
// save screen to file
void mgLinuxPlatform::screenShot(
  const char* fileName)
{
}
...
BOOL mgLinuxPlatform::checkErrors()
{
  if (m_support != NULL)
...
void mgLinuxPlatform::drawOverlayTexture(
  DWORD texture,
  int x, 
  int y,
  int width,
...
//--------------------------------------------------------------
// terminate view
void mgLinuxPlatform::termView()
{
}

//--------------------------------------------------------------
// create window 
void mgLinuxPlatform::createWindow()
{
...
//--------------------------------------------------------------
// destroy our window 
void mgLinuxPlatform::destroyWindow()
{
...
void mgLinuxPlatform::windowResized(
  int width,
  int height)
...
void mgLinuxPlatform::setMouseRelative(
  BOOL relative)
{
...
BOOL mgLinuxPlatform::getMouseRelative()
{
...
//--------------------------------------------------------------
// track mouse exit
void mgLinuxPlatform::trackMouse(
  int x,
  int y,
  int& dx,
  int& dy)
...
void mgLinuxPlatform::mouseMove(
  int x, 
  int y,
  int state)
{
...
//--------------------------------------------------------------
// handle mouse press
void mgLinuxPlatform::mouseDown(
  XButtonEvent& ev)   
{
  int dx, dy;
...
void mgLinuxPlatform::mouseEnter()
{
  // synch with real cursor again
  if (m_theApp != NULL)
    m_theApp->appMouseEnter(m_lastCursorX, m_lastCursorY);
...
//--------------------------------------------------------------
// mouse exited window
void mgLinuxPlatform::mouseExit()
{
  if (m_theApp != NULL)
...
int mgLinuxPlatform::translateKey(
  int key)
{
  switch (key)
  {
...
int mgLinuxPlatform::translateState(
  int state)
{
  int flags = 0;
  ...
  char** argv)
{
  ...
  mgLinuxPlatform* platform = NULL;
  try
  {
    // initialize platform services
    platform = new mgLinuxPlatform();
