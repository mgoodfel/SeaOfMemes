...
mgSurface* mgDX9Display::createOverlaySurface()
{
...
//--------------------------------------------------------------
// create a 2D graphics surface
mgSurface* mgDX9Display::createTextureSurface()
{
...
BOOL mgDX9Display::canRepeatTextures()
{
  return false;
}
...
//--------------------------------------------------------------
// set projection
void mgDX9Display::setProjection(
  int width,
  int height)
{
  mgWinSystem* framework = (mgWinSystem*) mgPlatform;
 mgDebug("view size is %d by %d", width, height);

  // set the projection
  FLOAT yFOV = (FLOAT) (framework->m_FOV*D3DX_PI/180.0f);
  D3DXMatrixPerspectiveFovLH(&m_state->m_projMatrix, yFOV, width/(FLOAT) height, 
...
void mgDX9Display::deleteBuffers()
{
...
void mgDX9Display::setLightAndFog()
{
  HRESULT hr;
...
void mgDX9Display::drawOverlayTexture(
...
mgIndexBuffer* mgDX9Display::newIndexBuffer(
  int size,
  BOOL dynamic)
{
...
//--------------------------------------------------------------
// set world transform
void mgDX9Display::setModelTransform(
  mgMatrix4& xform)
{
...
//--------------------------------------------------------------
// set light color
void mgDX9Display::setLightColor(
  double r,
  double g,
  double b)
{
...
//--------------------------------------------------------------
// set light ambient
void mgDX9Display::setLightAmbient(
  double r,
  double g,
  double b)
{
...
//--------------------------------------------------------------
// set transparent
void mgDX9Display::setTransparent(
  BOOL enable)
{
...
void mgDX9Display::setMouseRelative(
  BOOL relative)
{
  mgWinSystem* framework = (mgWinSystem*) mgPlatform;
...
//-----------------------------------------------------------------------------
// set cursor pattern
void mgDX9Display::setCursorTexture(
  const char* fileName,
  int hotX,
  int hotY)
{
...
void mgDX9Display::setGraphicsTiming(
  BOOL enabled)
{
  mgWinSystem* framework = (mgWinSystem*) mgPlatform;
...
void mgDX9Display::setMultiSample(
  BOOL enabled)
{
}
...
void mgDX9Display::setWindowPosn(
  int x,
  int y,
  int width,
  int height)
