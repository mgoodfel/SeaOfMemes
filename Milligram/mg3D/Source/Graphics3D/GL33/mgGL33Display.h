/*
  ...
  this notice.
*/
#if !defined(MGGL33DISPLAY_H) && defined(SUPPORT_GL33)
#define MGGL33DISPLAY_H
...
class mgGL33Shader : public mgShader
{
public:
...
class mgGL33Display : public mgDisplayServices
{ 
public:
...
protected:
  ...
  BOOL m_lighting;
  mgGL33Shader* m_shader;

  mgFramebufferHandle m_framebuffer;
