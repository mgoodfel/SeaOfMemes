/*
  ...
  this notice.
*/
#if !defined(MGGL21VERTEXBUFFER_H) && defined(SUPPORT_GL21)
#define MGGL21VERTEXBUFFER_H

#include "Graphics3D/mgVertexBuffer.h"

class mgGL21VertexBuffer : public mgVertexBuffer
{
public:
  // constructor
  mgGL21VertexBuffer(
