/*
  ...
  this notice.
*/
#if !defined(MGGL21DISPLAY_H) && defined(SUPPORT_GL21)
#define MGGL21DISPLAY_H
...
class mgGL21Shader : public mgShader
{
public:
...
class mgGL21Display : public mgDisplayServices
{ 
public:
  //----------------------- screen management ------------------
...
protected:
  ...
  mgGL21Shader* m_shader;                 // current shader
